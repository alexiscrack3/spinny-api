...
module Sidekiq
  class << self
    ...
    # @yield [@client_chain]
    #
    # source://sidekiq//lib/sidekiq.rb#140
    ...
    # source://sidekiq//lib/sidekiq.rb#168
    def default_job_options; end

    # source://sidekiq//lib/sidekiq.rb#160
    def default_job_options=(hash); end

    # source://sidekiq//lib/sidekiq.rb#152
    def default_server_middleware; end

    # deprecated
    #
    # source://activesupport/7.0.2.3/lib/active_support/deprecation/method_wrappers.rb#63
    ...
    # source://sidekiq//lib/sidekiq.rb#189
    ...
    #
    # source://sidekiq//lib/sidekiq.rb#245
    def error_handlers; end

    # source://sidekiq//lib/sidekiq.rb#185
    def load_json(string); end

    # source://sidekiq//lib/sidekiq.rb#193
    def log_formatter; end

    # source://sidekiq//lib/sidekiq.rb#201
    def log_formatter=(log_formatter); end

    # source://sidekiq//lib/sidekiq.rb#206
    def logger; end
    ...
    # @raise [ArgumentError]
    #
    # source://sidekiq//lib/sidekiq.rb#257
    def on(event, &block); end

    # source://sidekiq//lib/sidekiq.rb#55
    def options; end

    # source://sidekiq//lib/sidekiq.rb#59
    ...
    # source://sidekiq//lib/sidekiq.rb#132
    def redis=(hash); end

    # source://sidekiq//lib/sidekiq.rb#112
    def redis_info; end

    # source://sidekiq//lib/sidekiq.rb#128
    def redis_pool; end
    ...
    # source://sidekiq//lib/sidekiq.rb#263
    def strict_args!(mode = T.unsafe(nil)); end

    # source://sidekiq//lib/sidekiq.rb#51
    def ❨╯°□°❩╯︵┻━┻; end
  end
end
...
# source://sidekiq//lib/sidekiq.rb#19
...
module Sidekiq::JobUtil
  # @raise [ArgumentError]
  #
  # source://sidekiq//lib/sidekiq/job_util.rb#34
  def normalize_item(item); end

  # source://sidekiq//lib/sidekiq/job_util.rb#52
  ...
  # @raise [ArgumentError]
  #
  # source://sidekiq//lib/sidekiq/job_util.rb#9
  def validate(item); end

  # source://sidekiq//lib/sidekiq/job_util.rb#17
...
# source://sidekiq//lib/sidekiq/middleware/chain.rb#68
class Sidekiq::Middleware::Chain
  ...
  # source://sidekiq//lib/sidekiq/middleware/chain.rb#92
  ...
  # source://sidekiq//lib/sidekiq/middleware/chain.rb#109
  def insert_after(oldklass, newklass, *args); end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#102
  def insert_before(oldklass, newklass, *args); end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#132
  def invoke(*args); end

  # source://sidekiq//lib/sidekiq/middleware/chain.rb#97
...
class Sidekiq::Middleware::Entry
  ...
  #
  # source://sidekiq//lib/sidekiq/middleware/chain.rb#150
  def klass; end
...
class Sidekiq::RedisConnection
  class << self
    ...
    # source://sidekiq//lib/sidekiq/redis_connection.rb#53
    def build_client(options); end

    # source://sidekiq//lib/sidekiq/redis_connection.rb#71
    def client_opts(options); end

    # source://sidekiq//lib/sidekiq/redis_connection.rb#119
    def determine_redis_provider; end

    # source://sidekiq//lib/sidekiq/redis_connection.rb#94
    ...
    # @raise [ArgumentError]
    #
    # source://sidekiq//lib/sidekiq/redis_connection.rb#49
...
#
# source://sidekiq//lib/sidekiq.rb#273
