...
class Rack::Request
  ...
  #
  # source://rack/2.2.3/lib/rack/request.rb#26
  def initialize(env); end

  # source://rack/2.2.3/lib/rack/request.rb#40
  def delete_param(k); end

  # source://rack/2.2.3/lib/rack/request.rb#31
  def params; end

  # source://rack/2.2.3/lib/rack/request.rb#31
  def query; end

  # source://rack/2.2.3/lib/rack/request.rb#35
  ...
  class << self
    ...
    #
    # source://rack/2.2.3/lib/rack/request.rb#16
    def ip_filter; end
...
# source://rack/2.2.3/lib/rack/request.rb#20
Rack::Request::ALLOWED_SCHEMES = T.let(T.unsafe(nil), Array)

# source://rack/2.2.3/lib/rack/request.rb#21
...
class YARD::CLI::Yardoc < ::YARD::CLI::YardoptsCommand
  ...
  # @since 0.6.0
  #
  # source://yard//lib/yard/cli/yardoc.rb#752
...
class YARD::Config
  class << self
    ...
    # @since 0.6.2
    #
    # source://yard//lib/yard/config.rb#264
    def arguments; end
    ...
    # @since 0.6.2
    #
    # source://yard//lib/yard/config.rb#248
    ...
    # @since 0.6.2
    #
    # source://yard//lib/yard/config.rb#255
...
# source://yard//lib/yard/parser/ruby/ast_node.rb#523
class YARD::Parser::Ruby::ClassNode < ::YARD::Parser::Ruby::KeywordNode
  # source://yard//lib/yard/parser/ruby/ast_node.rb#526
  def block; end

  # source://yard//lib/yard/parser/ruby/ast_node.rb#524
  def class_name; end

  # source://yard//lib/yard/parser/ruby/ast_node.rb#525
  def superclass; end
end
...
class YARD::Parser::Ruby::CommentNode < ::YARD::Parser::Ruby::AstNode
  ...
  # source://yard//lib/yard/parser/ruby/ast_node.rb#547
  def first_line; end

  # source://yard//lib/yard/parser/ruby/ast_node.rb#546
  def source; end
end

# source://yard//lib/yard/parser/ruby/ast_node.rb#508
class YARD::Parser::Ruby::ConditionalNode < ::YARD::Parser::Ruby::KeywordNode
  ...
  # @return [Boolean]
  #
  # source://yard//lib/yard/parser/ruby/ast_node.rb#509
  def condition?; end

  # source://yard//lib/yard/parser/ruby/ast_node.rb#513
  def else_block; end
...
class YARD::Parser::Ruby::LoopNode < ::YARD::Parser::Ruby::KeywordNode
  ...
  # @return [Boolean]
  #
  # source://yard//lib/yard/parser/ruby/ast_node.rb#535
  def loop?; end
end

# source://yard//lib/yard/parser/ruby/ast_node.rb#431
class YARD::Parser::Ruby::MethodCallNode < ::YARD::Parser::Ruby::AstNode
  # source://yard//lib/yard/parser/ruby/ast_node.rb#457
  def block; end

  # source://yard//lib/yard/parser/ruby/ast_node.rb#455
  def block_param; end

  # @return [Boolean]
  #
  # source://yard//lib/yard/parser/ruby/ast_node.rb#432
  def call?; end

  # source://yard//lib/yard/parser/ruby/ast_node.rb#435
  def method_name(name_only = T.unsafe(nil)); end

  # source://yard//lib/yard/parser/ruby/ast_node.rb#433
  def namespace; end

  # source://yard//lib/yard/parser/ruby/ast_node.rb#446
  ...
  # @return [Boolean]
  #
  # source://yard//lib/yard/parser/ruby/ast_node.rb#467
...
# source://yard//lib/yard/parser/ruby/ast_node.rb#472
class YARD::Parser::Ruby::MethodDefinitionNode < ::YARD::Parser::Ruby::AstNode
  ...
  # @return [Boolean]
  #
  # source://yard//lib/yard/parser/ruby/ast_node.rb#473
  def kw?; end

  # source://yard//lib/yard/parser/ruby/ast_node.rb#477
  def method_name(name_only = T.unsafe(nil)); end
  ...
  # source://yard//lib/yard/parser/ruby/ast_node.rb#488
  def signature; end

  private

  # source://yard//lib/yard/parser/ruby/ast_node.rb#503
  def index_adjust; end
end

# source://yard//lib/yard/parser/ruby/ast_node.rb#529
...
module YARD::Templates::Template
  ...
  # source://yard//lib/yard/templates/template.rb#184
  def initialize(opts = T.unsafe(nil)); end
  ...
  #
  # source://yard//lib/yard/templates/template.rb#202
  def T(*path); end
  ...
  #
  # source://yard//lib/yard/templates/template.rb#283
  ...
  #
  # source://yard//lib/yard/templates/template.rb#310
  ...
  # @see #sections
  #
  # source://yard//lib/yard/templates/template.rb#237
  def init; end

  # source://yard//lib/yard/templates/template.rb#340
  def inspect; end
  ...
  # source://yard//lib/yard/templates/template.rb#335
  ...
  #
  # source://yard//lib/yard/templates/template.rb#250
  ...
  #
  # source://yard//lib/yard/templates/template.rb#224
  ...
  #   paths.
  #
  # source://yard//lib/yard/templates/template.rb#328
  ...
  #
  # source://yard//lib/yard/templates/template.rb#276
  def yieldall(opts = T.unsafe(nil), &block); end

  protected

  # source://yard//lib/yard/templates/template.rb#346
  def erb_file_for(section); end

  # source://yard//lib/yard/templates/template.rb#350
  def erb_with(content, filename = T.unsafe(nil)); end

  private

  # source://yard//lib/yard/templates/template.rb#397
  def add_options(opts = T.unsafe(nil)); end

  # @raise [ArgumentError]
  #
  # source://yard//lib/yard/templates/template.rb#376
  def cache(section); end

  # source://yard//lib/yard/templates/template.rb#386
  def cache_filename(section); end

  # source://yard//lib/yard/templates/template.rb#362
  def render_section(section, &block); end

  # source://yard//lib/yard/templates/template.rb#391
  def set_ivars; end

  # source://yard//lib/yard/templates/template.rb#410
