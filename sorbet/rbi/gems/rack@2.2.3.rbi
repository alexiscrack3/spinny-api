...
class Rack::CommonLogger
  ...
  #
  # source://rack//lib/rack/common_logger.rb#75
...
class Rack::ETag
  ...
  # source://rack//lib/rack/etag.rb#63
  def digest_body(body); end

  # @return [Boolean]
  #
  # source://rack//lib/rack/etag.rb#55
  def etag_body?(body); end

  # @return [Boolean]
  #
  # source://rack//lib/rack/etag.rb#51
  def etag_status?(status); end

  # @return [Boolean]
  #
  # source://rack//lib/rack/etag.rb#59
...
module Rack::Multipart
  class << self
    # source://rack//lib/rack/multipart.rb#59
    def build_multipart(params, first = T.unsafe(nil)); end

    # source://rack//lib/rack/multipart.rb#45
    def extract_multipart(req, params = T.unsafe(nil)); end

    # source://rack//lib/rack/multipart.rb#41
...
# source://rack//lib/rack/multipart.rb#23
...
class Rack::Multipart::Parser
  ...
  # source://rack//lib/rack/multipart/parser.rb#357
  ...
  # source://rack//lib/rack/multipart/parser.rb#329
...
# source://rack//lib/rack/multipart/parser.rb#327
...
class Rack::QueryParser
  ...
  #
  # source://rack//lib/rack/query_parser.rb#25
  ...
  # @raise [RangeError]
  #
  # source://rack//lib/rack/query_parser.rb#83
  ...
  # case.
  #
  # source://rack//lib/rack/query_parser.rb#64
  ...
  # @return [Boolean]
  #
  # source://rack//lib/rack/query_parser.rb#138
  def params_hash_type?(obj); end

  # source://rack//lib/rack/query_parser.rb#154
  def unescape(s); end
...
class Rack::Request
  ...
  # source://yard/0.9.27/lib/yard/server/rack_adapter.rb#86
  def version_supplied; end

  # source://yard/0.9.27/lib/yard/server/rack_adapter.rb#86
  def version_supplied=(_arg0); end

  # source://yard/0.9.27/lib/yard/server/rack_adapter.rb#88
  def xhr?; end
...
module Rack::Utils
  ...
  # source://rack//lib/rack/utils.rb#223
  ...
  #
  # source://rack//lib/rack/utils.rb#338
  def byte_ranges(env, size); end

  # source://rack//lib/rack/utils.rb#591
  def clean_path_info(path_info); end

  # :nocov:
  #
  # source://rack//lib/rack/utils.rb#83
  def clock_time; end

  # source://rack//lib/rack/utils.rb#299
  def delete_cookie_header!(header, key, value = T.unsafe(nil)); end

  # URI escapes. (CGI style space to +)
  #
  # source://rack//lib/rack/utils.rb#35
  def escape(s); end
  ...
  # true URI escaping.
  #
  # source://rack//lib/rack/utils.rb#41
  def escape_path(s); end

  # source://rack//lib/rack/utils.rb#343
  def get_byte_ranges(http_range, size); end

  # source://rack//lib/rack/utils.rb#269
  def make_delete_cookie_header(header, key, value); end

  # source://rack//lib/rack/utils.rb#206
  def parse_cookies(env); end

  # source://rack//lib/rack/utils.rb#210
  def parse_cookies_header(header); end

  # source://rack//lib/rack/utils.rb#98
  def parse_nested_query(qs, d = T.unsafe(nil)); end

  # source://rack//lib/rack/utils.rb#94
  def parse_query(qs, d = T.unsafe(nil), &unescaper); end

  # source://rack//lib/rack/utils.rb#130
  ...
  # weekday and month.
  #
  # source://rack//lib/rack/utils.rb#329
  def rfc2109(time); end

  # source://rack//lib/rack/utils.rb#316
  ...
  # source://rack//lib/rack/utils.rb#264
  ...
  #
  # source://rack//lib/rack/utils.rb#53
  def unescape(s, encoding = T.unsafe(nil)); end

  # Unescapes the **path** component of a URI.  See Rack::Utils.unescape for
  # unescaping query parameters or form components.
  #
  # source://rack//lib/rack/utils.rb#47
  ...
  class << self
    ...
    # source://rack//lib/rack/utils.rb#74
    def key_space_limit; end

    # source://rack//lib/rack/utils.rb#78
    ...
    # source://rack//lib/rack/utils.rb#66
    def param_depth_limit; end
...
class Rack::Utils::Context
  ...
  #
  # source://rack//lib/rack/utils.rb#393
  def app; end

  # source://rack//lib/rack/utils.rb#400
  def call(env); end
...
# source://rack//lib/rack/utils.rb#158
...
# @api private
#
# source://rack//lib/rack/utils.rb#417
class Rack::Utils::HeaderHash < ::Hash
  ...
  # @api private
  #
  # source://rack//lib/rack/utils.rb#456
  def [](k); end
  ...
  # @api private
  #
  # source://rack//lib/rack/utils.rb#439
  def clear; end

  # @api private
  #
  # source://rack//lib/rack/utils.rb#467
  def delete(k); end
  ...
  # @return [Boolean]
  #
  # source://rack//lib/rack/utils.rb#473
  def has_key?(k); end
...
# source://rack//lib/rack/utils.rb#577
