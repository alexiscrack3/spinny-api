...
#
# source://actionmailer//lib/action_mailer/base.rb#443
class ActionMailer::Base < ::AbstractController::Base
  ...
  #
  # source://actionmailer//lib/action_mailer/base.rb#609
  def initialize; end
  ...
  # source://actionpack/7.0.2.3/lib/abstract_controller/caching.rb#42
  ...
  # source://actionmailer//lib/action_mailer/base.rb#467
  ...
  # source://actionpack/7.0.2.3/lib/abstract_controller/caching/fragments.rb#23
  ...
  # for the same header.
  #
  # source://actionmailer//lib/action_mailer/base.rb#687
  ...
  #   end
  #
  # source://actionmailer//lib/action_mailer/base.rb#834
  def mail(headers = T.unsafe(nil), &block); end

  # Returns the name of the mailer object.
  #
  # source://actionmailer//lib/action_mailer/base.rb#642
  def mailer_name; end
  ...
  # source://actionmailer//lib/action_mailer/base.rb#954
  ...
  # source://actionmailer//lib/action_mailer/base.rb#974
  def each_template(paths, name, &block); end

  # source://actionmailer//lib/action_mailer/base.rb#1017
  def insert_part(container, response, charset); end

  # source://actionmailer//lib/action_mailer/base.rb#1031
  def instrument_name; end

  # This and #instrument_name is for caching instrument
  #
  # source://actionmailer//lib/action_mailer/base.rb#1024
  ...
  # used.
  #
  # source://actionmailer//lib/action_mailer/base.rb#879
  ...
  class << self
    ...
    #
    # source://actionmailer//lib/action_mailer/base.rb#486
    ...
    # @return [Boolean]
    #
    # source://actionmailer//lib/action_mailer/base.rb#907
    ...
    # If a string or symbol is passed in it will be camelized and constantized.
    #
    # source://actionmailer//lib/action_mailer/base.rb#519
    ...
    # If a string or symbol is passed in it will be camelized and constantized.
    #
    # source://actionmailer//lib/action_mailer/base.rb#505
    ...
    # source://actionmailer//lib/action_mailer/base.rb#523
...
module ActionMailer::Base::HelperMethods
  ...
  # source://actionpack/7.0.2.3/lib/abstract_controller/caching/fragments.rb#31
  def combined_fragment_cache_key(*args, **_arg1, &block); end

  # source://actionpack/7.0.2.3/lib/abstract_controller/caching.rb#43
  def view_cache_dependencies(*args, **_arg1, &block); end
end

# source://actionmailer//lib/action_mailer/base.rb#733
class ActionMailer::Base::LateAttachmentsProxy < ::SimpleDelegator
  # source://actionmailer//lib/action_mailer/base.rb#735
  def []=(_name, _content); end

  # source://actionmailer//lib/action_mailer/base.rb#734
  def inline; end
  ...
  # @raise [RuntimeError]
  #
  # source://actionmailer//lib/action_mailer/base.rb#738
  def _raise_error; end
end

# source://actionmailer//lib/action_mailer/base.rb#628
class ActionMailer::Base::NullMail
  # source://actionmailer//lib/action_mailer/base.rb#629
  def body; end

  # source://actionmailer//lib/action_mailer/base.rb#630
  def header; end
...
# source://actionmailer//lib/action_mailer/base.rb#462
...
class ActionMailer::MailDeliveryJob < ::ActiveJob::Base
  ...
  class << self
    # source://activejob/7.0.2.3/lib/active_job/queue_name.rb#56
    def queue_name; end
