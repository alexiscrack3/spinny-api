...
class ActionText::Attachables::ContentAttachment
  ...
  # source://activemodel/7.0.2.3/lib/active_model/validations.rb#52
  def _validators; end
  ...
  # source://activemodel/7.0.2.3/lib/active_model/naming.rb#244
  ...
  # source://activemodel/7.0.2.3/lib/active_model/validations.rb#48
...
class ActionText::Attachment
  ...
  # source://activesupport/7.0.2.3/lib/active_support/core_ext/module/delegation.rb#302
  ...
  # source://activesupport/7.0.2.3/lib/active_support/core_ext/module/delegation.rb#294
...
class ActionText::Content
  ...
  class << self
    ...
    # source://activesupport/7.0.2.3/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#48
    def renderer; end

    # source://activesupport/7.0.2.3/lib/active_support/core_ext/module/attribute_accessors_per_thread.rb#92
...
class ActionText::EncryptedRichText < ::ActionText::RichText
  ...
  class << self
    ...
    # source://activerecord/7.0.2.3/lib/active_record/attributes.rb#11
    def attributes_to_define_after_schema_loads; end

    # source://activerecord/7.0.2.3/lib/active_record/enum.rb#116
    def defined_enums; end

    # source://activerecord/7.0.2.3/lib/active_record/encryption/encryptable_record.rb#11
...
class ActionText::RichText < ::ActionText::Record
  ...
  # source://activerecord/7.0.2.3/lib/active_record/autosave_association.rb#160
  ...
  class << self
    ...
    # source://activerecord/7.0.2.3/lib/active_record/reflection.rb#11
...
module ActionText::RichText::GeneratedAssociationMethods
  # source://activerecord/7.0.2.3/lib/active_record/associations/builder/association.rb#103
  def record; end

  # source://activerecord/7.0.2.3/lib/active_record/associations/builder/association.rb#111
  def record=(value); end

  # source://activerecord/7.0.2.3/lib/active_record/associations/builder/belongs_to.rb#132
  def record_changed?; end

  # source://activerecord/7.0.2.3/lib/active_record/associations/builder/belongs_to.rb#136
  def record_previously_changed?; end

  # source://activerecord/7.0.2.3/lib/active_record/associations/builder/singular_association.rb#19
...
module ActionView::Helpers
  ...
  class << self
    # source://actionview/7.0.2.3/lib/action_view/helpers.rb#34
    def eager_load!; end
  end
end

class ActionView::Helpers::FormBuilder
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1695
  def initialize(object_name, object, template, options); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2609
  def button(value = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2433
  def check_box(method, options = T.unsafe(nil), checked_value = T.unsafe(nil), unchecked_value = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_options_helper.rb#905
  def collection_check_boxes(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_options_helper.rb#917
  def collection_radio_buttons(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_options_helper.rb#857
  def collection_select(method, collection, value_method, text_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2001
  def color_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2001
  def date_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/date_helper.rb#1225
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/date_helper.rb#1249
  def datetime_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2001
  def email_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2630
  def emitted_hidden_id?; end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1660
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1752
  def field_id(method, *suffixes, namespace: T.unsafe(nil), index: T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1772
  def field_name(method, *methods, multiple: T.unsafe(nil), index: T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2289
  def fields(scope = T.unsafe(nil), model: T.unsafe(nil), **options, &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2252
  def fields_for(record_name, record_object = T.unsafe(nil), fields_options = T.unsafe(nil), &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2516
  def file_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_options_helper.rb#869
  def grouped_collection_select(method, collection, group_method, group_label_method, option_key_method, option_value_method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2477
  def hidden_field(method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1732
  def id; end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1672
  def index; end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2364
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1675
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1670
  def object; end
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2455
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_options_helper.rb#845
  def select(method, choices = T.unsafe(nil), options = T.unsafe(nil), html_options = T.unsafe(nil), &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2548
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/date_helper.rb#1237
  def time_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_options_helper.rb#881
  def time_zone_select(method, priority_zones = T.unsafe(nil), options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1691
  def to_model; end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1687
  def to_partial_path; end
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_options_helper.rb#893
  def weekday_select(method, options = T.unsafe(nil), html_options = T.unsafe(nil)); end

  private

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2715
  def convert_to_legacy_options(options); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2697
  def fields_for_nested_model(name, object, fields_options, block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2668
  def fields_for_with_nested_attributes(association_name, association, options, block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2664
  def nested_attributes_association?(association_name); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2710
  def nested_child_index(name); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2635
  def objectify_options(options); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#2641
  def submit_default_value; end

  class << self
    # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1683
...
module ActionView::Helpers::FormHelper
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1568
  def _object_for_form_builder(object); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1335
  def check_box(object_name, method, options = T.unsafe(nil), checked_value = T.unsafe(nil), unchecked_value = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1365
  def color_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1429
  def date_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1494
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1548
  def email_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1071
  def fields(scope = T.unsafe(nil), model: T.unsafe(nil), **options, &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1020
  def fields_for(record_name, record_object = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1237
  def file_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#433
  def form_for(record, options = T.unsafe(nil), &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#754
  def form_with(model: T.unsafe(nil), scope: T.unsafe(nil), url: T.unsafe(nil), format: T.unsafe(nil), **options, &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#479
  def form_with_generates_ids; end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#479
  def form_with_generates_ids=(val); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#477
  def form_with_generates_remote_forms; end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#477
  def form_with_generates_remote_forms=(val); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1204
  def hidden_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1141
  def label(object_name, method, content_or_options = T.unsafe(nil), options = T.unsafe(nil), &block); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1513
  def month_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#481
  def multiple_file_field_include_hidden; end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#481
  def multiple_file_field_include_hidden=(val); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1556
  def number_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1186
  def password_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1397
  def phone_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1357
  def radio_button(object_name, method, tag_value, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1564
  def range_field(object_name, method, options = T.unsafe(nil)); end

  def rich_text_area(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1388
  def search_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1397
  def telephone_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1267
  def text_area(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1165
  def text_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1465
  def time_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1539
  def url_field(object_name, method, options = T.unsafe(nil)); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1530
  def week_field(object_name, method, options = T.unsafe(nil)); end

  private

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#463
  def apply_form_for_options!(object, options); end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1602
  def default_form_builder_class; end

  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1573
  ...
  # source://actionview/7.0.2.3/lib/action_view/helpers/form_helper.rb#1588
