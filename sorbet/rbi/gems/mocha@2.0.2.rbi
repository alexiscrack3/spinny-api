...
::BOOT_TIME = T.let(T.unsafe(nil), Float)
::DEPLOYMENT_NAME = T.let(T.unsafe(nil), String)

# source://autoprefixer-rails/10.2.5.1/lib/autoprefixer-rails/processor.rb#7
...
::Secrets = T.let(T.unsafe(nil), ActiveSupport::OrderedOptions)
