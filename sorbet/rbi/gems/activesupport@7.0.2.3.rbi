...
# source://activesupport//lib/active_support/cache.rb#827
ActiveSupport::Cache::Coders::MARK_70_UNCOMPRESSED = T.let(T.unsafe(nil), String)

# source://activesupport//lib/active_support/cache.rb#866
...
# source://activesupport//lib/active_support/cache.rb#879
...
class ActiveSupport::Cache::Entry
  ...
  #
  # source://activesupport//lib/active_support/cache.rb#919
  ...
  #
  # source://activesupport//lib/active_support/cache.rb#955
  def bytesize; end

  # source://activesupport//lib/active_support/cache.rb#970
  def compressed(compress_threshold); end

  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/cache.rb#966
  def compressed?; end
...
class ActiveSupport::Cache::NullStore < ::ActiveSupport::Cache::Store
  ...
  # source://activesupport//lib/active_support/cache/strategy/local_cache.rb#144
  ...
  # source://activesupport//lib/active_support/cache/strategy/local_cache.rb#135
...
# specified in bytes.
#
# source://activesupport//lib/active_support/cache.rb#177
class ActiveSupport::Cache::Store
  ...
  #
  # source://activesupport//lib/active_support/cache.rb#203
  def initialize(options = T.unsafe(nil)); end
  ...
  #
  # source://activesupport//lib/active_support/cache.rb#574
  def cleanup(options = T.unsafe(nil)); end
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#584
  def clear(options = T.unsafe(nil)); end
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#565
  def decrement(name, amount = T.unsafe(nil), options = T.unsafe(nil)); end
  ...
  # Options are passed to the underlying cache implementation.
  #
  # source://activesupport//lib/active_support/cache.rb#517
  ...
  #   cache.fetch('foo') # => "bar"
  #
  # source://activesupport//lib/active_support/cache.rb#349
  ...
  # @raise [ArgumentError]
  #
  # source://activesupport//lib/active_support/cache.rb#469
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#556
  def increment(name, amount = T.unsafe(nil), options = T.unsafe(nil)); end
  ...
  #
  # source://activesupport//lib/active_support/cache.rb#219
  def mute; end
  ...
  # Options are passed to the underlying cache implementation.
  #
  # source://activesupport//lib/active_support/cache.rb#384
  ...
  #
  # source://activesupport//lib/active_support/cache.rb#417
  def read_multi(*names); end
  ...
  # Silences the logger.
  #
  # source://activesupport//lib/active_support/cache.rb#213
  def silence!; end
  ...
  #
  # source://activesupport//lib/active_support/cache.rb#429
  ...
  # source://activesupport//lib/active_support/cache.rb#633
  ...
  #   # => 'cache:foo'
  #
  # source://activesupport//lib/active_support/cache.rb#717
  ...
  # source://activesupport//lib/active_support/cache.rb#756
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#614
  def read_entry(key, **options); end

  # Reads multiple entries from the cache implementation. Subclasses MAY
  # implement this method.
  #
  # source://activesupport//lib/active_support/cache.rb#639
  ...
  # source://activesupport//lib/active_support/cache.rb#624
  ...
  # @raise [NotImplementedError]
  #
  # source://activesupport//lib/active_support/cache.rb#620
  def write_entry(key, entry, **options); end

  # Writes multiple entries to the cache implementation. Subclasses MAY
  # implement this method.
  #
  # source://activesupport//lib/active_support/cache.rb#658
  ...
  class << self
    ...
    # source://activesupport//lib/active_support/cache.rb#185
...
module ActiveSupport::Cache::Strategy::LocalCache
  ...
  # source://activesupport//lib/active_support/cache/strategy/local_cache.rb#163
  def local_cache; end
  ...
  # source://activesupport//lib/active_support/cache/strategy/local_cache.rb#171
  def use_temporary_local_cache(temporary_cache); end

  # source://activesupport//lib/active_support/cache/strategy/local_cache.rb#149
...
#
# source://activesupport//lib/active_support/message_encryptor.rb#86
class ActiveSupport::MessageEncryptor
  ...
  #
  # source://activesupport//lib/active_support/message_encryptor.rb#152
  def encrypt_and_sign(value, expires_at: T.unsafe(nil), expires_in: T.unsafe(nil), purpose: T.unsafe(nil)); end

  private

  # source://activesupport//lib/active_support/message_encryptor.rb#185
  def _decrypt(encrypted_message, purpose); end

  # source://activesupport//lib/active_support/message_encryptor.rb#168
  def _encrypt(value, **metadata_options); end

  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/message_encryptor.rb#217
  def aead_mode?; end

  # source://activesupport//lib/active_support/message_encryptor.rb#211
  def new_cipher; end
  ...
  class << self
    # source://activesupport//lib/active_support/message_encryptor.rb#92
    ...
    # source://activesupport//lib/active_support/message_encryptor.rb#89
...
# source://activesupport//lib/active_support/message_encryptor.rb#121
...
class ActiveSupport::SafeBuffer < ::String
  ...
  # source://activesupport//lib/active_support/core_ext/string/output_safety.rb#259
  ...
  # source://activesupport//lib/active_support/core_ext/string/output_safety.rb#248
  def encode_with(coder); end
  ...
  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/core_ext/string/output_safety.rb#236
  def html_safe?; end

  # source://activesupport//lib/active_support/core_ext/string/output_safety.rb#194
...
class ActiveSupport::TestCase < ::Minitest::Test
  ...
  # source://minitest/5.15.0/lib/minitest/assertions.rb#707
  def assert_no_match(matcher, obj, msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#636
  def assert_not_empty(obj, msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#647
  def assert_not_equal(exp, act, msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#659
  def assert_not_in_delta(exp, act, delta = T.unsafe(nil), msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#671
  def assert_not_in_epsilon(a, b, epsilon = T.unsafe(nil), msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#678
  def assert_not_includes(collection, obj, msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#689
  def assert_not_instance_of(cls, obj, msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#699
  def assert_not_kind_of(cls, obj, msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#717
  def assert_not_nil(obj, msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#728
  def assert_not_operator(o1, op, o2 = T.unsafe(nil), msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#751
  def assert_not_predicate(o1, op, msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#759
  def assert_not_respond_to(obj, meth, msg = T.unsafe(nil)); end

  # source://minitest/5.15.0/lib/minitest/assertions.rb#768
  def assert_not_same(exp, act, msg = T.unsafe(nil)); end

  # test/unit backwards compatibility methods
  #
  # source://minitest/5.15.0/lib/minitest/assertions.rb#394
  ...
  # source://minitest/5.15.0/lib/minitest.rb#289
  def method_name; end
...
class Array
  ...
  #   # =>  [1, 2, true]
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#308
  ...
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#293
  ...
  #   [1,2].to_fs          # => "[1, 2]"
  #
  # source://activesupport//lib/active_support/core_ext/array/conversions.rb#95
  def to_formatted_s(format = T.unsafe(nil)); end
...
module ERB::Util
  ...
  #   # => "&lt;&lt; Accept &amp; Checkout"
  #
  # source://activesupport//lib/active_support/core_ext/string/output_safety.rb#50
...
module Enumerable
  ...
  #   # => { b: 1, f: true }
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#218
  def compact_blank; end
  ...
  #   # => {foo: 1, baz: 3}
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#166
  def excluding(*elements); end
  ...
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#230
  ...
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#146
  def including(*elements); end
  ...
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#86
  def index_by; end
  ...
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#109
  ...
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#35
  def maximum(key); end
  ...
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#27
  def minimum(key); end
  ...
  #   # => [1, "David"]
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#195
  def pick(*keys); end
  ...
  #   # => [[1, "David"], [2, "Rafael"]]
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#179
  def pluck(*keys); end
  ...
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#57
...
# exactly one item.
#
# source://activesupport//lib/active_support/core_ext/enumerable.rb#9
...
class Hash
  ...
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#251
  def compact_blank; end
  ...
  #   # => { b: 1, f: true }
  #
  # source://activesupport//lib/active_support/core_ext/enumerable.rb#261
  def compact_blank!; end
...
module I18n
  class << self
    # source://i18n/1.10.0/lib/i18n/backend/cache.rb#64
    def cache_key_digest; end

    # source://i18n/1.10.0/lib/i18n/backend/cache.rb#68
    def cache_key_digest=(key_digest); end

    # source://i18n/1.10.0/lib/i18n/backend/cache.rb#56
    def cache_namespace; end

    # source://i18n/1.10.0/lib/i18n/backend/cache.rb#60
    def cache_namespace=(namespace); end

    # source://i18n/1.10.0/lib/i18n/backend/cache.rb#48
    def cache_store; end

    # source://i18n/1.10.0/lib/i18n/backend/cache.rb#52
    def cache_store=(store); end

    # source://i18n/1.10.0/lib/i18n/backend/fallbacks.rb#17
    def fallbacks; end

    # source://i18n/1.10.0/lib/i18n/backend/fallbacks.rb#23
    def fallbacks=(fallbacks); end

    # source://i18n/1.10.0/lib/i18n/interpolate/ruby.rb#16
    def interpolate(string, values); end

    # source://i18n/1.10.0/lib/i18n/interpolate/ruby.rb#22
    def interpolate_hash(string, values); end

    # source://i18n/1.10.0/lib/i18n.rb#37
    def new_double_nested_cache; end

    # source://i18n/1.10.0/lib/i18n/backend/cache.rb#72
    def perform_caching?; end

    # source://i18n/1.10.0/lib/i18n.rb#45
    def reserve_key(key); end

    # source://i18n/1.10.0/lib/i18n.rb#50
    def reserved_keys_pattern; end
  end
end

# source://i18n/1.10.0/lib/i18n/interpolate/ruby.rb#5
I18n::DEFAULT_INTERPOLATION_PATTERNS = T.let(T.unsafe(nil), Array)

# source://i18n/1.10.0/lib/i18n.rb#35
I18n::EMPTY_HASH = T.let(T.unsafe(nil), Hash)

# source://i18n/1.10.0/lib/i18n/interpolate/ruby.rb#10
I18n::INTERPOLATION_PATTERN = T.let(T.unsafe(nil), Regexp)

# source://i18n/1.10.0/lib/i18n/backend/key_value.rb#21
I18n::JSON = ActiveSupport::JSON

# source://i18n/1.10.0/lib/i18n.rb#19
...
# source://i18n/1.10.0/lib/i18n/version.rb#4
...
class Numeric
  ...
  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/core_ext/string/output_safety.rb#128
  def html_safe?; end
...
class Object < ::BasicObject
  ...
  # @return [Boolean]
  #
  # source://activesupport//lib/active_support/core_ext/string/output_safety.rb#122
  def html_safe?; end
...
# source://regexp_parser/2.4.0/lib/regexp_parser/token.rb#2
...
class String
  ...
  #
  # source://activesupport//lib/active_support/core_ext/string/output_safety.rb#336
  def html_safe; end
...
# source://nokogiri/1.13.4/lib/nokogiri/html4/element_description_defaults.rb#11
